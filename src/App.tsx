  ...
  return (
    <div className="App">
      <header className="App-header">
        <Button onClick={e => {e.preventDefault(); alert()}} btnType={ ButtonType.Default }>Default</Button>
        <Button disabled className="custom"> Disabled</Button>
        ...
        <Button btnType={ButtonType.Link} href="https://www.google.com" target="_blank">Google Link(disabled)</Button>
        <p>
